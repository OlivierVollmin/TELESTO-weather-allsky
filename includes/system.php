...
function DisplaySystem()
{
    ...
    <div class="row">
        <div class="col-lg-12">
			...
			<div class="col-md-6">
				<figure>
				<img style = "width:100%" src = "../cpu_temp.png">
				<figcaption> Remark : CPU temperature spikes in the morning are due to the processing of the night generated data </figcaption>
				</figure>
			</div>
                    </div><!-- /.row -->
			...
			<div style="margin-bottom: 15px">
				...
				<button type="submit" class="btn btn-danger" style="margin-bottom:5px" name="service_stop"/><i class="fa fa-stop"></i> Stop Allsky</button>
                        ...
                        <div> auto reboot scheduled at 10:12 every day </div>
