 ...
 * 
 * Modified by Olivier Vollmin : olivier.vollmin@alumni.epfl.ch
 * - Spring 2021
 * (added weather window, api window, remove autentification)
 */
...
//include_once('includes/authenticate.php'); // removes password at start
...
include_once('includes/liveweather.php'); //added weather
...
<head>
    ...
    <meta name="author" content="Thomas Jacquin/modified Olivier Vollmin">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="index.php?page=live_weather"><i class=""></i> Live Weather</a>
                    </li>
                    <li>
                        <a href="includes/api.php"><i class=""></i> JSON Weather database </a>
                    </li>
                    <li>
                        <a href="includes/api2.php"><i class=""></i> JSON CPU Temp </a>
                    </li>
